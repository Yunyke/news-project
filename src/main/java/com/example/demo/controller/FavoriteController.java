...
public class FavoriteController {
	...
	@GetMapping("/status")
	public ResponseEntity<List<Long>> getFavoritedNewsIds(@RequestParam List<Long> newsIds,
			@RequestParam("userId") Integer userId) {
		List<Long> favorited = favoriteService.getFavoriteNewsIdsByUser(userId, newsIds);
